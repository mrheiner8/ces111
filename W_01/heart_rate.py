...
max_rate = 220 - age
min_rate = max_rate * .65
top_rate = max_rate * .85

print(f"When you exercise to strengthen your heart, you should keep your heart rate between {min_rate:.0f} and {top_rate:.0f} beats per minute.")
