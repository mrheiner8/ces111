...
# Calls and tests the functions found in water_flow.py
...
def test_pressure_loss_from_pipe():
        assert pressure_loss_from_pipe(0.048692, 0.00, 0.018, 1.75) == approx(0.00, abs=0.001)
        assert pressure_loss_from_pipe(0.048692, 200.00, 0.00, 1.75) == approx(0.00, abs=0.001)
        assert pressure_loss_from_pipe(0.048692, 200.00, 0.018,0.00) == approx(0.00, abs=0.001)
...
def test_convert_kpa_to_psi():
      ...
      assert convert_kpa_to_psi(10) == approx(1.450, abs=0.001)
      assert convert_kpa_to_psi(158.7) == approx(23.017, abs=0.001)
      assert convert_kpa_to_psi(160) == approx(23.206, abs=0.001)
